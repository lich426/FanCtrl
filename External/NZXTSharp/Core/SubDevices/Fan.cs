...
namespace NZXTSharp
{
    ...
    public class Fan : ISubDevice {
        ...
        /// <summary>
        /// Whether or not the current <see cref="Fan"/> instance is active (on).
        /// </summary>
        ...
        /// <summary>
        /// Returns the number of LEDs available on the <see cref="Fan"/>.
        /// </summary>
        public int NumLeds { get => 8; }

        /// <summary>
        /// A list containing the power states of the <see cref="Fan"/>'s LEDs.
        /// </summary>
        public bool[] Leds { get => _Leds; }

        /// <summary>
        /// Constructs a <see cref="Fan"/> instance.
        /// </summary>
        public Fan() {
        ...
        /// <summary>
        /// Toggles the <see cref="Fan"/>'s state.
        /// </summary>
        ...
        /// <summary>
        /// Toggles a specific LED owned by the <see cref="Fan"/> device.
        /// </summary>
        /// <param name="Index">The index in the <see cref="Fan"/>'s <see cref="Leds"/> list to toggle.</param>
        ...
        /// </summary>
        /// <param name="Start">The index in the <see cref="Fan"/>'s <see cref="Leds"/> list to start at.</param>
        /// <param name="End">The index in the <see cref="Fan"/>'s <see cref="Leds"/> list to end at.</param>
        ...
        /// <summary>
        /// Sets all LEDs in the <see cref="Fan"/>'s <see cref="Leds"/> list to true.
        /// </summary>
        ...
        /// <summary>
        /// Sets all LEDs in the <see cref="Fan"/>'s <see cref="Leds"/> list to false.
        /// </summary>
