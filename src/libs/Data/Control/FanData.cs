...
namespace FanCtrl
{
    ...
    public class FanData
    {
        ...
        public FanData(string id, FanValueUnit unit, bool isStep, int hysteresis, int auto, int delayTime)
        {
            ID = id;
            IsStep = isStep;
        ...
        {
            var fanData = new FanData(ID, Unit, IsStep, Hysteresis, Auto, DelayTime);
            for (int i = 0; i < this.getMaxFanValue(); i++)
            {
